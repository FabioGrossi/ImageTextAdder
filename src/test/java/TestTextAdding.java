...
public class TestTextAdding {
    ...
    public static void main(String[] args) throws IOException, FontFormatException {
        ...
        float adaptFontSize = ImageTextAdder.getAdaptFontSize(bufferedImage, text, font, Color.RED, 400, 200);

        BufferedImage editedImage = ImageTextAdder.drawTextInCenteredSquare(bufferedImage, text, font.deriveFont(adaptFontSize), Color.RED, 400, 200);
